...
#### Q1
Q: 사이트에 네이버 광고 전환 추적 스크립트와 네이버 애널리틱스 스크립트 두개를 삽입하면 어떻게 보이나요? <br>
...
#### Q2
Q: 전환로그가 발생하고 다른 페이지로 바로 이동하는 페이지의 경우 어시스턴트에서는 어떻게 보여지나요? <br>
...
#### Q3
Q: 스크립트 설치 관련 문의 또는 지원을 받고 싶으면 어디에 연락하면 되나요? <br>
